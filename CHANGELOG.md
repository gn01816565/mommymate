...
- 建立 tailwind.config.js (darkMode: 'class')
- 建立 postcss.config.js
- 建立 src/index.css (Tailwind directives)
- 更新 index.html (移除 CDN script)
- 更新 index.tsx (import CSS)

**解決問題：**
- ✅ 移除 Tailwind CDN production 警告
- ✅ 減少網路請求
- ✅ 提升 Lighthouse 效能評分
